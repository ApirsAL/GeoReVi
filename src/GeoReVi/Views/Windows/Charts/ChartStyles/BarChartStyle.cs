                                ...
                                try
                                {
                                    if (ds.EDH.CalculateDistribution)
                                    {
                                        ...
                                        for (double b = ds.Values.Min() - 0.5 * (ds.Values.Max() - ds.Values.Min()); b <= ds.Values.Max() + 0.5 * (ds.Values.Max() - ds.Values.Min()); b += (ds.Values.Max() - ds.Values.Min()) / 400)
                                        {
                                            ...
                                            ds.LineSeriesBar.LinePoints2.Add(new Point(a, value));
                                        }
                                    }
                        ...
                        foreach (var ds in BarCollection)
                        {
                            ...
                            try
                            {
                                if (ds.EDH.CalculateDistribution)
                                {
                                    ...
                                    {
                                        double value = ds.EDH.GetNormalDistributionValue(mean, standardDeviation, b);
                                        ds.LineSeriesBar.LinePoints2.Add(new Point(b, value));
                                    }
                                }
                ...
                case BarTypeEnum.VerticalOverlay:
                    if (nSeries > 1)
                    {
                        ...
                        foreach (var ds in BarCollection)
                        {
                            ...
                            {
                                SetVerticalBarSideBySide(ds.BarPoints[i], ds, width, j, nSeries);
                            }
                    ...
                    if (nSeries > 1)
                    {
                        ...
                        foreach (var ds in BarCollection)
                        {
                            ...
                            for (int i = 0; i < ds.BarPoints.Count; i++)
                            {
                                ...
                                SetVerticalBar(ds.BarPoints[i], ds, width, tempy[i]);
                            }
                ...
                case BarTypeEnum.Horizontal:
                    if (nSeries == 1)
                    {
                        foreach (var ds in BarCollection)
                        {
                            ...
                            for (int i = 0; i < ds.BarPoints.Count; i++)
                            {
                                SetHorizontalBar(ds.BarPoints[i], ds, width, 0);
                            }
                        }
                    }
                    else
                    {
                        ...
                        foreach (var ds in BarCollection)
                        {
                            ...
                            for (int i = 0; i < ds.BarPoints.Count; i++)
                            {
                                SetHorizontalBar1(ds.BarPoints[i], ds, nSeries, j);
                            }
                    ...
                    if (nSeries > 1)
                    {
                        ...
                        foreach (var ds in BarCollection)
                        {
                            ...
                            for (int i = 0; i < ds.BarPoints.Count; i++)
                            {
                                ...
                                SetHorizontalBar(ds.BarPoints[i], ds, width, tempy[i]);
                            }
