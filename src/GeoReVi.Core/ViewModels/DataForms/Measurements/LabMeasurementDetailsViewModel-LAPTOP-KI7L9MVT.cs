...
namespace GeoReVi
{
    ...
    public class LabMeasurementDetailsViewModel : Screen, IHandle<ShortCutMessage>
    {
        ...
        private BindableCollection<LineSeries> ls;
        public BindableCollection<LineSeries> Ls
        {
            get => this.ls;
            set
            {
                this.ls = value;
                NotifyOfPropertyChange(() => Ls);
            }
        }
        #endregion
        ...
        public async Task LoadData()
        {
            ...
            await ch.RunBackgroundWorkerHelperAsync(() => ((ShellViewModel)IoC.Get<IShell>(null)).IsLoading, async () =>
            {
                try
                {
                    try
        ...
        private async void OnSelectedRockSampleChanged()
        {
            CommandHelper ch = new CommandHelper();
        ...
        //Activating a background worker to select and download Files asynchronously
        private async void OnSelectedLaboratoryMeasurementChanged()
        {
            ...
            await ch.RunBackgroundWorkerHelperAsync(() => IsFileLoading, async () =>
            {
                IsFileLoading = true;
                    try
                    {
                        FileStore = await FileHelper.LoadFilesAsync(SelectedLaboratoryMeasurement.labmeIdPk, cts.Token, "LabMeasurement");
